...
export const command : SlashCommand = {
  ...
  execute: async (interaction) => {
    ...
    for (const member of members) {
      ...
      const characters : Character = await fetchData(`https://raider.io/api/v1/characters/profile?region=eu&realm=Elune&name=${memberGuild}&fields=mythic_plus_previous_weekly_highest_level_runs`)
